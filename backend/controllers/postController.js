...
//   try {
//     let reply = await Reply.create({ postId: req.params.postId, author: req.user.id, content });
...
//     if (reply.author.toString() !== req.user.id) return res.status(403).json({ message: 'Unauthorized' });
